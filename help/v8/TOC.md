...
+ Aan de slag {#new}
   ...
   + [Veelgestelde vragen](start/campaign-faq-comprehensive.md)
   + [Veelgestelde vragen](start/campaign-faq.md)
+ Beheer en machtigingen {#permissions}
...
+ Berichten verzenden {#send}
   ...
   + Sms {#sms}
      ...
      + [Een sms-levering maken](send/sms/create-sms.md)
      + [De inhoud definiëren](send/sms/sms-content.md)
      + [De doelgroep selecteren](send/sms/sms-audience.md)
      + [SMS-proefdrukken verzenden](send/sms/sms-proofs.md)
   ...
   + Andere kanalen {#other-channels}
      + [REGELS](send/line/line.md)
      + [Direct mail](send/direct-mail.md)
      + [X (Twitter)](send/twitter.md)
      + [Aangepast extern kanaal](send/custom-channel.md)
   + Inhoud personaliseren {#personalize}
      ...
      + [Gepersonaliseerde coupons](send/personalized-coupons.md)
      + [Gepersonaliseerde PDF-documenten genereren](send/generating-personalized-pdf-documents.md)
      + [De lijst met emoticons aanpassen](send/customizing-emoticon-list.md)
...
+ Profiel- en publieksbeheer {#audience}
   ...
   + [Werken met filters](audiences/create-filters.md)
   ...
   + Soorten publiek maken {#create-audiences}
      ...
      + [Soorten publiek delen met Adobe-oplossingen](start/shared-audiences.md)
   + [Best practices](audiences/audiences-best-practices.md)
   + [Lidmaatschappen beheren](start/subscriptions.md)
+ Openingspagina&#39;s en webinhoud {#content}
...
+ Workflows {#workflows}
   ...
   + [&#x200B; Volledige Documentatie van het Werkschema > &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/about-workflows.html?lang=nl-NL)
...
+ Beheer en interacties van aanbiedingen {#offers}
   ...
   + Configuratie-instellingen {#interaction-settings}
...
+ Data management {#data}
   + De database opvragen {#query}
      ...
      + [Werken met publieksfilters](audiences/create-filters.md)
...
+ Integraties {#connect}
   ...
   + Campagne + Experience Platform {#ac-aep}
      ...
      + [AEP-profielen bijwerken vanaf bestemmingspagina&#39;s voor campagnes](connect/ac-aep-landing-pages.md)
...
+ Configuratie {#config}
   ...
   + Instellingen {#settings}
      ...
      + [Werken met opsommingen](config/enumerations.md)
...
+ Bronnen voor ontwikkelaars {#developer}
   ...
   + Schema&#39;s en formulieren {#schemas-forms}
   ...
   + REST API&#39;s {#apis}
      ...
      + Services en abonnement beheren {#managing-services-and-subscriptions}
