...
* In de context van een [&#x200B; plaatsing van de Onderneming (FFDA) &#x200B;](../../v8/architecture/enterprise-deployment.md), wordt geen bidirectionele gegevensreplicatie verstrekt: de replicatie gebeurt slechts van het lokale gegevensbestand van de Campagne aan het gegevensbestand van de Wolk
