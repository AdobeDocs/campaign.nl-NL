...
Leer meer over [!DNL Campaign] v8 architectuur in [ deze pagina ](../../v8/architecture/architecture.md). Testen
...
Gelieve te merken op dat sommige mogelijkheden niet beschikbaar in de context van een [ plaatsing van de Onderneming (FFDA) ](../../v8/architecture/enterprise-deployment.md) van Campagne, zoals zijn:
