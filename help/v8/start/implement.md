...
Leer hoe u gebruikers aan Adobe Campaign kunt toevoegen in [deze sectie](../start/gs-permissions.md).
...
1. **Profielen importeren en publiek maken**
   ...
   [Leer hoe u profielen importeert](import.md).
   ...
   [Leer hoe u het publiek definieert](audiences.md).
...
1. **Tabellen en schema&#39;s**
   ...
   Zie deze sectie voor meer informatie over [Ingebouwd datamodel voor campagne](../dev/datamodel.md).
...
1. **Dashboards en lijsten**
   ...
   Leer hoe u filters en lijsten beheert in Campagne in [deze pagina](../dev/customize.md#gs-lists-and-filters).
...
1. **Rapporten**
   ...
   Meer informatie over rapportagemogelijkheden in Campagne in [deze pagina](../reporting/gs-reporting.md).
...
Ontdek de volledige lijst met Adobe oplossingen die kunnen worden geïntegreerd met Adobe Campaign [op deze pagina](../connect/integration.md).
...
Meer informatie over beschikbare connectors in [deze sectie](../connect/integration.md).
...
Leer hoe u uw CRM-systeem kunt aansluiten op Campagne in [deze sectie](../connect/integration.md#gs-crm-connectors)
...
Leer hoe te om de module van FDA van de Campagne te vormen om toegangsparameters te bepalen in [deze sectie](../connect/integration.md#gs-fda)
