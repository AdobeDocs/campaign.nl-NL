...
* Probleem verholpen waarbij de voorbereiding van de levering mislukte bij het toepassen van aangepaste typologische regels met drukregels. (NEO-94457)
* Probleem verholpen waarbij de clientconsole problemen met de verwerking van HTTP-aanvragen kon ervaren. (NEO-94071)
...
* De externe rekeningen van Snowflake steunen nu authentificatie OAuth2, die moderne en veilige authentificatiemethodes voor gefedereerde verbindingen van de gegevenstoegang verstrekt. (NEO-87013) [Meer informatie](../config/external-accounts.md#snowflake-external-accounts)
