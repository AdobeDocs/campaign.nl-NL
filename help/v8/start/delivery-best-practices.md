...
Leer meer hoe te om een nieuw platform in de [&#x200B; Gids van de Beste praktijken van de Levering van Adobe te beginnen &#x200B;](https://experienceleague.adobe.com/nl/docs/deliverability-learn/deliverability-best-practice-guide/additional-resources/campaign/ac-starting-new-platform){target="_blank"}.
...
### Levering en onderhoud {#delivery-maintenance}

Regelmatig onderhoud van uw leveringen is essentieel voor optimale prestaties van het platform.

+++ **las uit weinig beste praktijken**

* **verwijder ontbroken en onnodige leveringen**: Bezorgd geen leveringen in ontbroken staat op de instantie, aangezien dit tijdelijke lijsten en beïnvloedingsprestaties handhaaft. Regelmatig leveringen verwijderen die niet meer nodig zijn om systeembronnen vrij te maken.

* **Schone inactieve ontvangers**: De Inactieve ontvangers in de laatste 12 maanden zouden uit het gegevensbestand moeten worden verwijderd om adreskwaliteit te handhaven. ISPs deactiveert adressen na een periode van inactiviteit, en de berichten worden teruggestuurd naar afzenders om hen over deze nieuwe status te informeren. Regelmatige lijstopmaak verbetert de leverbaarbaarheid en verlaagt de kosten.

* **Plan grote leveringen verstandig**: Plan geen grote leveringen samen. Coördineer de planning van leveringen met de andere leden van uw team om de lading gelijkmatig over het systeem uit te spreiden. Wanneer er meerdere grote leveringen tegelijk worden verzonden, kan dit van invloed zijn op de algehele prestaties van het platform.
...
Sommige e-mailclients blokkeren afbeeldingen standaard, en gebruikers kunnen hun instellingen wijzigen om afbeeldingen te blokkeren zodat ze op gegevensgebruik kunnen worden opgeslagen.  Als afbeeldingen niet worden gedownload, kan het hele bericht verloren gaan.
...
[Meer informatie over trackingsmogelijkheden](../send/tracking.md)
