...
Door pagina&#39;s te plaatsen in Campagne kunt u leads vastleggen, abonnementen beheren en gegevens verzamelen via webformulieren. De campagne biedt twee methodes aan: de **console van de Cliënt** voor geavanceerde vormen met complexe logica, en het **Web UI van de Campagne** voor snel, modern het landen paginaverwezenlijking met een belemmering-en-dalingsredacteur.

**UI van het Web van de Campagne (geadviseerd voor de meeste gebruikers):**

* De visuele editor gebruiken om responsieve bestemmingspagina&#39;s te ontwerpen
* Formuliervelden, afbeeldingen en inhoudsblokken toevoegen met slepen en neerzetten
* Formuliervelden toewijzen aan databasekenmerken
* Pre-fill-, bevestigingsberichten en bedankpagina&#39;s configureren
* Inzendingen in real-time publiceren en bijhouden

**de console van de Cliënt (voor geavanceerde gebruiksgevallen):**

* Aangepaste webtoepassingen maken met complexe bedrijfslogica
* Geavanceerde veldtoewijzingsregels en validatieregels definiëren
* Formulieren met meerdere pagina&#39;s maken met voorwaardelijke routering
* Toegang tot het volledige gegevensmodel van de Campagne voor verrijking

**Verwante onderwerpen:**

[&#x200B; creeer het landen pagina&#39;s (Web UI) &#x200B;](https://experienceleague.adobe.com/nl/docs/campaign-web/v8/landing-pages/get-started-lp){target="_blank"} | [&#x200B; de toepassingen van het Web (de console van de Cliënt) &#x200B;](../dev/landing-pages.md)
