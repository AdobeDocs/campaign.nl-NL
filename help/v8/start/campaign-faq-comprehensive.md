...
hide: true
hidefromtoc: true
source-git-commit: e583a915012670156c73d111476c1fbeea27a787
workflow-type: tm+mt
source-wordcount: '12525'
ht-degree: 4%
...
**Nota:** als u op-gebouw of hybride plaatsing nodig hebt, blijft Campaign Classic v7 beschikbaar met volledige steun.
...
* **Logboeken van het Werkschema** - toegang gedetailleerde uitvoeringslogboeken om kwesties problemen op te lossen
* **Heatmap** - visualiseer werkschemaactiviteit en identificeer prestatiesknelpunten
* **[spoor van de Controle](../reporting/audit-trail.md)** - spoor alle wijzigingen die aan werkschema&#39;s worden aangebracht
* **Alarm** - de berichten van de opstelling voor werkschemamislukkingen of vertragingen
