...
Campagne v8 is een Adobe-platform dat ideaal is voor organisaties die grootschalige campagnes nodig hebben (20M-bewerkingen per uur), moderne webinterface, cloudnative voordelen en ondersteuning op lange termijn.
...
[&#x200B; de gebieden van de Personalisatie &#x200B;](../send/personalization-fields.md) | [&#x200B; Voorwaardelijke inhoud &#x200B;](../send/conditions.md)
...
[&#x200B; Spoor en controleer leveranties &#x200B;](../send/tracking.md) | [&#x200B; Beste praktijken van de Levering &#x200B;](delivery-best-practices.md)
...
[&#x200B; Analyse van de Levering &#x200B;](../send/delivery-analysis.md) | [&#x200B; verzendt en volgt leveringen &#x200B;](../send/send.md)
...
[&#x200B; het volgen van de Verbinding gids &#x200B;](../send/tracking.md) | [&#x200B; het Volgen beste praktijken &#x200B;](../send/send.md)
...
[&#x200B; Controle van de Levering &#x200B;](../send/send.md) | [&#x200B; het Volgen gids &#x200B;](../send/tracking.md)
...
[&#x200B; de activiteit van de Planner &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/scheduler.html?lang=nl-NL){target="_blank"} | [&#x200B; Terugkomende leveringen &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/sending-a-birthday-email.html){target="_blank"} | [&#x200B; automatisering van de Campagne &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/home.html?lang=nl-NL){target="_blank"}
...
+++ Hoe controleer ik dat mijn exploitanten en toestemmingen veiligheid beste praktijken volgen?

Adobe Campaign v8 biedt de mogelijkheid om alle huidige instellingen voor administratieve accounts op het hoogste niveau en geprivilegieerde accounts te vergelijken met aanbevolen beveiligde standaardwaarden.

* **Huidige montages (volledig zicht):** Alle montages voor administratieve en bevoorrechte rekeningen kunnen in **[!UICONTROL Administration]** worden herzien > **[!UICONTROL Access management]** (cliëntconsole of het Web UI van de Campagne): **[!UICONTROL Operators]**, **[!UICONTROL Operator groups]**, **[!UICONTROL Named rights]** (b.v. BEHEER, GOEDKEURINGSBEHEER), en omslag-vlakke toestemmingen. De beheerders van het product kunnen instantie-vlakke montages in [&#x200B; Controlebord van de Campagne &#x200B;](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html?lang=nl){target="_blank"} (IP lijst van gewenste personen, toestemmingen URL, instantiedetails, en meer) ook herzien.
* **geadviseerde veilige gebreken:** de [&#x200B; richtlijnen van de Veiligheid &#x200B;](../config/security.md) bepalen de geadviseerde veilige basislijn voor administratieve en bevoorrechte rekeningen, die omvatten: creeer voldoende veiligheidsgroepen, wijs aangewezen toegangsrechten per exploitant toe, en beperk gebruik van de adminexploitant en admingroep. Wanneer toepasselijk, zie ook [&#x200B; Verbeterde veiligheid toe:voegen-op &#x200B;](../config/enhanced-security.md) voor netwerk en encryptie het verharden.
* **Vergelijking:** de Beheerders vergelijken hun huidige configuratie met deze gedocumenteerde aanbevelingen om hiaten te identificeren en met veilige gebreken te richten.

**Verwante onderwerpen:**

[&#x200B; krijgen begonnen met toestemmingen &#x200B;](gs-permissions.md) | [&#x200B; de richtlijnen van de Veiligheid &#x200B;](../config/security.md) | [&#x200B; Verbeterde veiligheid toe:voegen-op &#x200B;](../config/enhanced-security.md)
...
[&#x200B; Spoor en controleer leveranties &#x200B;](../send/tracking.md) | [&#x200B; vorm getraceerde verbindingen &#x200B;](../send/tracked-links.md) | [&#x200B; het volgen van de Test &#x200B;](../send/testing-tracking.md)
...
Campagne v8 biedt FDA (Federated Data Access) voor het zoeken naar en gebruiken van gegevens die zijn opgeslagen in externe databases zonder het gegevensmodel van de campagne te wijzigen. U vormt een externe rekening, dan gebruik FDA in werkschema&#39;s, vragen, en het richten om externe gegevens met de profielen van de Campagne te combineren.

De beschikbaarheid van FDA en de verbindingsvereisten zijn afhankelijk van uw implementatie en licentie. Bekijk ondersteunde databases en vereiste versies in de compatibiliteitsmatrix.

**Verwante onderwerpen:**

[&#x200B; vormen verbindingen FDA &#x200B;](../connect/fda.md) | [&#x200B; de matrijs van de Verenigbaarheid &#x200B;](compatibility-matrix.md)
...
**als de kwestie (geavanceerd) voortduurt:**

Sluit de clientconsole en verwijder vervolgens handmatig de lokale cachebestanden uit uw gebruikersprofiel.

**Hand geheim voorgeheugenschoonmaakbeurt (Vensters):**

1. Selecteer **[!UICONTROL File]** > **[!UICONTROL Clear the local cache...]** in de clientconsole.
2. Log uit en sluit de clientconsole.
3. Ga naar de cachelocatie op basis van uw Windows-versie. Voor Windows 10: `C:\Users\<Username>\AppData\Roaming\Neolane\NL_5\`
4. Verwijder de `nlclient-config-<alphanumerical>.xml` -bestanden en de bijbehorende mappen.

>[!IMPORTANT]
>
>Verwijder `nlclient_cnx.xml` niet.

Adobe Support kan de juiste cachelocatie voor uw versie en besturingssysteem bevestigen en u door een veilige handmatige opruiming begeleiden.

Leer meer in [&#x200B; installeer en vorm cliëntconsole &#x200B;](connect.md)

+++

+++ Kan Adobe Campaign integreren met LDAP?

Nee. Campagne v8 ondersteunt geen LDAP-integratie. Voor verificatie wordt Adobe IMS (Adobe ID of Federated ID) gebruikt. Als u migreert op basis van Campaign Classic v7, bekijkt u niet-ondersteunde functies en wijzigingen in de verificatie.

**Verwante onderwerpen:**

[&#x200B; verbind met Campagne v8 &#x200B;](connect.md) | [&#x200B; Niet gestaafde eigenschappen in v8 &#x200B;](v7-to-v8.md#gs-removed)
...
De campagne schrapt automatisch alle gegevens verbonden aan een gegevenssubject: ontvankelijke profiel, levering en het volgen logboeken, douanegegevens met eigendomsverhoudingen, en abonnementsgeschiedenis.
...
* **[Veelgestelde vragen van Versies en van Verbeteringen Veelgestelde vragen](upgrades.md)** - controleer uw versie en leer over verbeteringen
