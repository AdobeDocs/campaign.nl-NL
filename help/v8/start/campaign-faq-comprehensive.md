...
**Algemene middelen:** [&#x200B; de capaciteitmatrijs van de Campagne v8 &#x200B;](https://experienceleague.adobe.com/en/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [&#x200B; de matrijs van de Verenigbaarheid &#x200B;](compatibility-matrix.md)
