...
?? Meer informatie over segmentatie, publiekscreatie en personalisatie vindt u in [deze sectie](audiences.md).
...
?? Leer hoe u een campagne ontwerpt, plant en uitvoert in [deze sectie](campaigns.md).
...
?? Meer informatie over rapport en het volgen mogelijkheden in [deze sectie](reporting.md).
...
?? Ben je al bekend met Campaign Classic? Leer belangrijke verschillen tussen Campaign Classic en Campagne v8 in [deze pagina](capability-matrix.md).
...
↗️ Leer hoe te om de werkruimte van de Campagne in [Campaign Classic v7 documentatie ](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-workspace.html){target=&quot;_blank&quot; te gebruiken

↗️ Leer hoe te om lijsten in [Campaign Classic v7 documentatie ](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-ui-lists.html){target=&quot;_blank&quot; aan te passen

U hebt ook toegang tot bepaalde functies via het web.

?? [Meer informatie over de Toegang van het Web van de Campagne](../start/connect.md#web-access).
