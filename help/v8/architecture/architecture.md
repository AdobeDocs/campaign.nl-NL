...
>[!IMPORTANT]
>
>De gesplitste verpletterende wijze wordt toegelaten door gebrek voor de &quot;Gesplitste Levering - E-mail&quot;rekening. Neem voor alle andere kanalen externe accounts contact op met uw Adobe Transition Manager om deze optie in te schakelen.
>
...
* De **instantie van de Uitvoering** wint inkomende gebeurtenissen (wachtwoordteruggestelde of orden van een website bijvoorbeeld) terug en verzendt gepersonaliseerde berichten. Er kunnen meer dan één uitvoeringsinstantie zijn om berichten te verwerken via het taakverdelingsmechanisme en het aantal gebeurtenissen te schalen dat voor maximale beschikbaarheid moet worden verwerkt.
