...
Adobe Campaign vereenvoudigt de personalisatie: u kunt verschillende typen inhoud weergeven die voor elke ontvanger zijn aangepast met één [berichtsjabloon](create-templates.md). In je transactieberichten, zoals het e-mailbericht voor bevestiging van de aankoop of het verlaten van het winkelwagentje, moet je voor elk individu informatie over productaanbiedingen opnemen in één e-mailtemplate.
