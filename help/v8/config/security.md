...
description: Aanbevolen veilige configuratiebegeleiding voor Campagne
feature: Privacy, PI
role: Developer
level: Beginner
...
Deze aanbevolen beveiligde configuratiehandleiding wordt openbaar gepubliceerd op Experience League. U kunt deze zonder beperkingen gebruiken en delen:

* **Deze pagina** - [ de veiligheid beste praktijken van de Campagne ](#ac-security) (controlelijst en gedetailleerde secties)
* **[Verbeterde veiligheid toe:voegen-op](enhanced-security.md)** - Veilige integratie CMK en Veilige het een tunnel graven van VPN
* **[worden begonnen met toestemmingen](../start/gs-permissions.md)** - Toegang en productprofielen
* **[Beperk PII mening](../dev/restrict-pi-view.md)** - het Beperken van toegang tot gevoelige gebieden
* **[Richtlijnen van de Implementatie](../start/implement.md)** - Veiligheid en privacy alvorens u begint
