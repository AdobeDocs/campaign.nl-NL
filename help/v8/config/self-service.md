...
[Klik hier](https://experienceleague.adobe.com/docs/control-panel/using/faq.html#control-panel){target="_blank"} om toegang te krijgen tot Veelgestelde vragen over het Configuratiescherm.
