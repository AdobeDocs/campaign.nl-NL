...
Alle vormattributen zijn vermeld in [ Campaign Classic v7 documentatie ](https://experienceleague.adobe.com/developer/campaign-api/api/control-Button.html){target="_blank"}.
